...
export function loadCredentials(path: string = CREDENTIALS_FILE): Credentials | null {
...
export function saveCredentials(creds: Credentials, path: string = CREDENTIALS_FILE): void {
...
export function clearCredentials(path: string = CREDENTIALS_FILE): boolean {
