...
export const CONSULT_SPECIALIST_TOOL: Tool = {
  type: "function",
  function: {
    name: "consult_specialist",
    description:
      "Get a second opinion or hand off ONE genuinely hard sub-piece of the current task — " +
    ...
    parameters: {
      ...
      properties: {
        task: {
          type: "string",
          description:
            "The one hard sub-piece to hand off, as a complete, self-contained instruction " +
